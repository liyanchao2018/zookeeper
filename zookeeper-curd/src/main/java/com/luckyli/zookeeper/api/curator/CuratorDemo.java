...
public class CuratorDemo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //当前节点的创建和删除事件监听
        addListenerWithNodeCache(curatorFramework,"/liyanchao");
        //子节点的增加、修改、删除的事件监听
//        addListenerWithPathChildCache(curatorFramework,"/liyanchao");

        //综合节点监听事件
//        addListenerWithTreeCache(curatorFramework,"/liyanchao");
        System.in.read();
